chaajaauserpagesdimdict = {'ga_user_pages_C': {'DateTime': 'dateHourMinute', 'ClientId': 'dimension1', 'Page Path': 'pagePath', 'Page Title': 'pageTitle'},
...
chaajaausereventsdimdict = {'ga_user_events_C': {'DateTime': 'dateHourMinute', 'ClientId': 'dimension1', 'Event Category': 'eventCategory', 'Event Label': 'eventLabel'},
...
chaajaauser = {'view': '****', 'viewId': '****',
'pages': {'dimdict': chaajaauserpagesdimdict, 'mets': {'Time on page': 'timeonpage', 'Page views': 'pageviews'}},
'events': {'dimdict': chaajaausereventsdimdict, 'mets': {'Total Events': 'totalevents', 'Unique Events': 'uniqueevents'}}
}
